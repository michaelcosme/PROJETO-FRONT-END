...
let posiAtual = 0;
let conta = 0;
const imgs = 5; // Total number of slides
...
if (cartModal) { // Verifica se o modal do carrinho existe na página
...
// AGORA É FEITA POR UM SCRIPT INLINE NO HEAD DE CADA HTML para evitar FOUC (Flash of Unstyled Content)

// Apenas a lógica de TOGGLE (alternar) permanece aqui
if (darkModeToggle) { // Verifica se o botão existe na página
    // Define o ícone inicial com base no estado atual do dark mode
    // Note: Usamos document.body aqui, consistente com o script inline
